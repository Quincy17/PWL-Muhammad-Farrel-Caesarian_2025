     ...
     <div class="card card-outline card-primary">
         <div class="card-header">
             ...
             <div class="card-tools">
                ...
                <a href="{{ url('/stok/export_excel') }}" class="btn btn-sm btn-primary mt-1"><i class="fa fa-fileexcel"></i> Export Stok (Excel)</a>
                <a href="{{ url('/stok/export_pdf') }}" class="btn btn-sm mt-1 btn-warning"><i class="fa fa-filepdf"></i> Export Stok (PDF)</a>
