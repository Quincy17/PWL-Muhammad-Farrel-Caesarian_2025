...
@else
<form action="{{ url('/penjualan_detail/' . $penjualanDetail->detail_id . '/delete_ajax') }}" method="POST" id="formdelete">
  @csrf
  @method('DELETE')
  <div id="modal-master" class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table class="table table-sm table-bordered table-striped">
          <tr>
            ...
            <td class="col-9">{{ $penjualanDetail->detail_id }}</td>
          </tr>
          <tr>
            <th class="text-right col-3">ID Penjualan :</th>
            <td class="col-9">{{ $penjualanDetail->penjualan->penjualan_id }}</td>
          </tr>
          <tr>
            <th class="text-right col-3">ID Barang :</th>
            <td class="col-9">{{ $penjualanDetail->barang->barang_id }}</td>
          </tr>
          <tr>
